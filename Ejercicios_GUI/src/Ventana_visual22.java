 ...
 * @author JEREMY
 */
public class Ventana_visual22 extends javax.swing.JFrame {
JLabel etiNum1;
JLabel etiNum2;
JTextField txtNum1;
JTextField txtNum2;
...
JButton btnRestar;
    /**
     * Creates new form Ventana_visual22
     */
    public Ventana_visual22() {
        initComponents();
        CreacionVentana();
    }
 ...
 public void btnSumarActionPerformed(ActionEvent evt) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_visual22.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_visual22().setVisible(true);
            }
        });
    }
