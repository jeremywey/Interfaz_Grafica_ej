 ...
 * @author JEREMY
 */
public class Ventana_visual9 extends javax.swing.JFrame {

    /**
     * Creates new form Ventana_visual9
     */
    public Ventana_visual9() {
        initComponents();
...
etiValor.setText("El valor es: "+spiValor.getValue().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_visual9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_visual9().setVisible(true);
            }
        });
    }
